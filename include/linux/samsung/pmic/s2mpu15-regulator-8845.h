...
#if IS_ENABLED(CONFIG_S2MPU15_ADC_8845)
...
/* INST_ACOK, JIG_REBOOT_EN mask */
#define S2MPU15_INST_ACOK_EN	(1 << 2)	// CFG_PM reg
#define S2MPU15_JIG_REBOOT_EN	(1 << 7)	// TIME_CTRL reg
...
#define S2MPU15_BUCK_MODE_SHIFT		2
#define S2MPU15_BUCK_MODE_MASK		0x0C
#define S2MPU15_BUCK_AUTO_MODE		(0x02 << S2MPU15_BUCK_MODE_SHIFT)
#define S2MPU15_BUCK_FCCM_MODE		(0x03 << S2MPU15_BUCK_MODE_SHIFT)
...
extern int main_pmic_mem_sel_status(void);
