/*
 * s2mpu15.h - Driver for the s2mpu15
 *
...
#ifndef __S2MPU15_MFD_H__
#define __S2MPU15_MFD_H__
...
struct s2mpu15_platform_data {
	struct s2mpu15_regulator_data *regulators;
