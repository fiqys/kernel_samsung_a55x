...
typedef union {
	...
	struct {
		unsigned USB_Highest_Speed:3;
		unsigned Alternate_Modes:3;
		unsigned Vbus_Required:1;
		unsigned Vconn_Required:1;
		unsigned Vconn_Power:3;
		unsigned:11;
		unsigned Connector_Type:2;
		unsigned Device_Capability:4;
		unsigned:1;
		unsigned UFP_VDO_Version:3;
	} product_type_vdo_ufp;

	struct {
		unsigned Port_Number:5;
		unsigned:17;
		unsigned Connector_Type:2;
		unsigned Host_Capability:3;
		unsigned:2;
		unsigned DFP_VDO_Version:3;
	} product_type_vdo_dfp;

	struct {
		unsigned pad:32;
	} product_type_vdo_pad;
	...
	struct {
		unsigned:16;
		unsigned Internal_Temp:8;
		unsigned Present_Input:8;
	} status_type1;

	struct {
		unsigned Present_Battery_Input:8;
		unsigned:1;
		...
		unsigned:3;
		unsigned Temperature_Status:8;
		unsigned Power_Status:8;
	} status_type2;

	struct {
		unsigned Power_State_Change:8;
		unsigned:24;
	} status_type3;
	...
	struct {
		unsigned PID:16;
		char  Manufacturer_String1:8;
		char  Manufacturer_String2:8;
	} Manufacturer_Info2;

	struct {
		char  Manufacturer_String1:8;
		char  Manufacturer_String2:8;
		char  Manufacturer_String3:8;
		char  Manufacturer_String4:8;
	} Manufacturer_Info3;
	...
	struct {
		unsigned:16;
		unsigned VID:16;
	} Source_Capabilities_Extended_Data_Block_Type1;

	struct {
		unsigned PID:16;
		unsigned XID1:16;
	} Source_Capabilities_Extended_Data_Block_Type2;

	struct {
		unsigned XID2:16;
		unsigned FW_Version:8;
		unsigned HW_Version:8;
	} Source_Capabilities_Extended_Data_Block_Type3;

	struct {
		unsigned Voltage_Regulation:8;
		unsigned Holdup_Time:8;
		unsigned Compliance:8;
		unsigned Touch_Current:8;
	} Source_Capabilities_Extended_Data_Block_Type4;
	struct {
		unsigned Peak_Current1:16;
		unsigned Peak_Current2:16;
	} Source_Capabilities_Extended_Data_Block_Type5;

	struct {
		unsigned Peak_Current3:16;
		unsigned Touch_Temp:8;
		unsigned Source_Inputs:8;
	} Source_Capabilities_Extended_Data_Block_Type6;

	struct {
		unsigned Number_of_Batteries_Slots:8;
		unsigned SPR_Source_PDP_Rating:8;
		unsigned ERP_Source_PDP_Rating:8;
		unsigned:8;
	} Source_Capabilities_Extended_Data_Block_Type7;
...
enum usbpd_control_msg_type {
	...
	/* Custom */
	USBPD_Get_Source_Info		= 23,
	USBPD_Get_Revision		= 24,
	USBPD_UVDM_MSG			= 31,
};
...
enum id_header_connector_type {
	Connector_Reserved	= 0x00,
	Connector_reserved2	= 0x01,
	Connector_Receptacle	= 0x02,
	Connector_Plug		= 0x03,
};
